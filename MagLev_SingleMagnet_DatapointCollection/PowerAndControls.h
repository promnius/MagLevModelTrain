...
void adjustMagnetPowerLevels(){
  ...
  if (powerLevel<0){digitalWrite(pinMAGNETDIRECTION7, MAGNET7NORTH);}else{digitalWrite(pinMAGNETDIRECTION7, !MAGNET7NORTH);}
  analogWrite(pinMAGNETPWM7, maxResolution - abs(powerLevel));
}
